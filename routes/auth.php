...
Route::middleware('guest')->group(function () {
    ...
    Route::post('/register/verify', [RegisterWithOtpController::class, 'store'])->name('register.store');

    Route::get('/register/verify/store', [RegisterWithOtpController::class, 'registerVerifyOtp'])->name('register.verify.otp');
