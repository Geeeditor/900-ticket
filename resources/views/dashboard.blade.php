...
@section('content')
    ...
    <section class="mb-6 mt-2">
        ...
        <ul class="banner">
            ...
            <li class="banner-item" style="background: #f6bd60;">
                <img class="h-full w-auto object-contain" src="{{ asset('image/banner/AirportTransfer-v3-Recovered.jpg') }}"
                    alt="">
            </li>
                ...
                <div class="rounded-md border border-gray-200 bg-white py-2 shadow shadow-gray-300">
                    ...
                    <div class="px-2 py-2">
                        <div class="flex w-full flex-row items-center gap-1">
                            ...
                            <div class="flex h-[70%] w-[20%] items-center justify-center rounded-full bg-red-700 p-2">
                                <a href="javascript:void(0)">
                                    <img class="w-[20px]" src="{{ asset('image/icons/clipboard.svg') }}"
                                        alt="lorem ipsum">
                                </a>
    ...
    <section class="bg-white">
        <div class="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-sm text-center">
                <h2 class="mb-4 text-4xl font-extrabold capitalize leading-tight tracking-tight text-gray-900">The journey
                ...
                <div class="rounded-md border border-gray-200 bg-white py-2 shadow shadow-gray-300">
                    <div class=" ">
                        ...
                        <div class="px-5 py-2">
                            ...
                            <p class="mb-3 truncate font-normal text-gray-700">Here are the biggest enterprise technology
    ...
    <section class="bg-red-700">
      ...
      <div class="mx-auto max-w-6xl text-center">
        ...
        <p class="text-sm text-gray-300 md:text-xl">Be part of our elite community. Get VIP access to curated content, early product releases, and special promotions.</p>

        <div class="mt-14 flex flex-col items-center justify-center rounded-lg bg-white p-8 shadow-lg md:flex-row">
          <input type="email" placeholder="Enter your email" class="w-full border-b-2 border-red-700 bg-transparent px-4 py-3 text-base text-[#2e0249] placeholder-red-700 placeholder-opacity-70 focus:outline-none md:w-96" />
          <button class="rounded bg-red-700 px-6 py-3 font-medium text-white hover:scale-105 hover:transform hover:bg-red-500 hover:shadow-md focus:outline-none max-md:mt-6 md:ml-4">
            Get Started
          </button>
        </div>
      </div>
