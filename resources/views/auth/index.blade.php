...
@section('content')
 <section
        class="blur-background w-full flex-col items-center justify-center">
        ...
        <div class="bg-white px-3 py-2">
            ...
            <div class="flex gap-3">
                <a id="loginLink" class="cursor-pointer font-[400] no-underline hover:underline"
                    onclick="showSection('login')">Login</a>
                <a id="signupLink" class="cursor-pointer font-[600] text-red-900 underline hover:no-underline"
                    onclick="showSection('signup')">Sign-Up</a>
            </div>
        </div>
        {{-- Login Section --}}
        <div id="loginSection" class="h-fit  flex-col gap-2 rounded-sm bg-white px-3 py-2 shadow-lg">
            <div>
                <form action="{{route('auth.login')}}" method="post" class="flex flex-col gap-2" action="javascript:void(0)">
                    @csrf
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <div class="flex items-center">
                            <input class="input" id="loginPassword" type="password" name="password"
                                placeholder="Enter your password">
                            <input type="checkbox" id="toggleLoginPassword" class="ml-2"
        ...
        {{-- Sign up section --}}
        <div id="signupSection" class="hidden h-fit  flex-col gap-2 rounded-sm bg-white px-3 pb-2 shadow-lg">
            <div>
                <form class="flex flex-col gap-2" action="javascript:void(0)">
                    ...
                    <div class="login-field flex flex-col gap-1">
                        ...
                        <span class="text-[12px] font-[200] text-red-700">This field is required</span>
                    </div>
                    ...
                    <div class="flex flex-col gap-1">
                        <label class="font-[500]" for="password">Password</label>
                        <div class="flex items-center">
                            <input class="input" id="signupPassword" type="password" name="password"
                                placeholder="Enter Password">
                            <input type="checkbox" id="toggleSignupPassword" class="ml-2"
