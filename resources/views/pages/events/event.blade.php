                        ...
                        <div class="w-full md:w-1/2">
                            ...
                            <div class="flex justify-between">
                                <a href="#" class="text-[#1F242F] font-[700] text-[20px] flex gap-1 items-center">
                                    <img class="rotate-180 w-[15px]"  src="{{asset('image/login.svg')}}" alt="lorem ipsum">
                                    BACK
                                </a>
                    ...
                    <div>
                        ...
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26"
                                fill="none">
                                <path
                                    d="M16.6 13H9.4M25 13C25 19.6274 19.6274 25 13 25C6.37258 25 1 19.6274 1 13C1 6.37258 6.37258 1 13 1C19.6274 1 25 6.37258 25 13Z"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none">
                                <path
                                    d="M12.8372 8.65116C12.8372 8.18879 12.4624 7.81395 12 7.81395C11.5376 7.81395 11.1628 8.18879 11.1628 8.65116V11.1628H8.65116C8.18879 11.1628 7.81395 11.5376 7.81395 12C7.81395 12.4624 8.18879 12.8372 8.65116 12.8372H11.1628V15.3488C11.1628 15.8112 11.5376 16.186 12 16.186C12.4624 16.186 12.8372 15.8112 12.8372 15.3488V12.8372H15.3488C15.8112 12.8372 16.186 12.4624 16.186 12C16.186 11.5376 15.8112 11.1628 15.3488 11.1628H12.8372V8.65116Z"
                                    fill="#131313" />
                                <path fill-rule="evenodd" clip-rule="evenodd"
