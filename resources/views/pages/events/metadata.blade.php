    ...
    <main x-data="{ checkoutModal: false }">
        ...
        <section class="mx-auto my-3 w-[85%] md:w-[80%]">
            @php
                ...
                $vvipPrice = 100100.05;
                $tax = 2;
                $event_reference = '900Ticket/' . 996680;
        ...
        <section x-transition:enter="transition-transform duration-300 ease-out"
            ...
            <div class="relative mx-auto w-full md:mt-[132px] md:w-[100%]">
                <form class="rounded-md bg-white px-[1rem] py-4 shadow-md md:px-8"
                    action="{{ route('event.addtocart') }}" method="post">
                    @csrf
                    ...
                    <div class="flex flex-col gap-2 md:flex-row md:gap-4">
                        ...
                        <div class="w-full md:w-1/2">
                            ...
                            <div class="flex justify-between">
                                ...
                                <button type="submit" class="rounded-md bg-[#cc2121] px-4 py-2 text-white">
